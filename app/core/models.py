...
class IdentificacaoPropNegocio(models.Model):
    ...
    contacto_prop_negocio = models.CharField(max_length=255, null=True, blank=True)
    doc_identificacao_prop_negocio = models.CharField(max_length=255, null=True, blank=True)
    outro_doc_ident_prop_negocio = models.CharField(max_length=255, null=True, blank=True)
    photo_prop_negocio = models.CharField(max_length=255, null=True, blank=True)
    bairro_vive_prop_negocio = models.CharField(max_length=255, null=True, blank=True)
    bairro_localizacao_negocio = models.CharField(max_length=255, null=True, blank=True)
    numero_senha_localizacao_negocio_gmaps = models.CharField(max_length=255, null=True, blank=True)
    coordenadas_estabelecimento_comercial = models.CharField(max_length=255, null=True, blank=True)
    nome_comercial_negocio = models.CharField(max_length=255, null=True, blank=True)
    tipo_negocio = models.CharField(max_length=255, null=True, blank=True)
    outro_tipo_negocio = models.CharField(max_length=255, null=True, blank=True)
    proprietario_estrutura_comercial = models.CharField(max_length=255, null=True, blank=True)
    como_conseguiu_estrutura_comercial = models.CharField(max_length=255, null=True, blank=True)
    outra_forma_conseguiu_est_comercial = models.CharField(max_length=255, null=True, blank=True)
    tempo_que_possui_estrutura_comercial = models.CharField(max_length=255, null=True, blank=True)
    tem_documento_que_confirma_propriedade_estabelecimento = models.CharField(max_length=255, null=True, blank=True)
    foto_documento_estabelecimento = models.CharField(max_length=255, null=True, blank=True)
    outro_doc_confirma_prop_estabelecimento = models.CharField(max_length=255, null=True, blank=True)
    tipo_material_construcao_estab_comercial_piso = models.CharField(max_length=255, null=True, blank=True)
    outro_tipo_material_est_come_piso = models.CharField(max_length=255, null=True, blank=True)
    tipo_material_construcao_estab_comercial_parede = models.CharField(max_length=255, null=True, blank=True)
    outro_tipo_material_est_come_parede = models.CharField(max_length=255, null=True, blank=True)
    tipo_material_construcao_estab_comercial_tecto = models.CharField(max_length=255, null=True, blank=True)
    outro_tipo_material_construcao_tecto = models.CharField(max_length=255, null=True, blank=True)
    tem_trabalhadores_envolvidos_negocio = models.CharField(max_length=255, null=True, blank=True)
    numero_trabalhadores = models.PositiveIntegerField(null=True, blank=True)
    valor_inicial_investido_no_seu_negocio = models.CharField(max_length=255, null=True, blank=True)
    outro_valor_inicial_no_seu_negocio = models.CharField(max_length=255, null=True, blank=True)
    rendimento_bruto_mensal_negocio = models.CharField(max_length=255, null=True, blank=True)
    outro_rendimento_bruto_mensal_negocio = models.CharField(max_length=255, null=True, blank=True)
    lucro_medio_mensal_negocio = models.CharField(max_length=255, null=True, blank=True)
    outro_lucro_medio_mensal_negocio = models.CharField(max_length=255, null=True, blank=True)
    outras_fontes_renda_negocio = models.CharField(max_length=255, null=True, blank=True)

class ExpectativaCompensacaoNegocio(models.Model):
    identificacao_prop_negocio = models.OneToOneField(IdentificacaoPropNegocio, on_delete=models.CASCADE)
    compensacao_esperada_negocio = models.CharField(max_length=255, null=True, blank=True)
    localizacao_estrutura_receber = models.CharField(max_length=255, null=True, blank=True)
    outra_localizacao_estrutura_receber = models.CharField(max_length=255, null=True, blank=True)
    outra_compensacao_esperada_negocio = models.CharField(max_length=255, null=True, blank=True)
    foto_esboco_estrutura_negocio = models.CharField(max_length=255, null=True, blank=True)
    termo_consentimento_estrutura_negocio = models.CharField(max_length=255, null=True, blank=True)
...
class CaracteristicasAggFamiliar(models.Model):
    ...
    tempo_a_familia_vive_no_talhao = models.CharField(max_length=255, null=True, blank=True)
...
class MembroFamilia(models.Model):
    ...
    deficiencia_fisica_mental = models.CharField(max_length=255, null=True, blank=True)

class PatrimonioRendaConsumo(models.Model):
    inquerito = models.ForeignKey(Inquerito, on_delete=models.CASCADE)
    familia_possui_bens = models.CharField(max_length=255, null=True, blank=True)
...
class EstruturasHabitacionais(models.Model):
    ...
    de_que_material_feita_vedacao_talhao = models.CharField(max_length=255, null=True, blank=True)
    outro_material_vedacao = models.CharField(max_length=255, null=True, blank=True)
    ...
    quanto_tempo_tem_casa_principal = models.CharField(max_length=255, null=True, blank=True)
    familia_tem_duat_talhao = models.CharField(max_length=255, null=True, blank=True)
    familia_possui_outra_estrutura_fora_deste_talhao = models.CharField(max_length=255, null=True, blank=True)
    localizacao_outra_estrutura = models.CharField(max_length=255, null=True, blank=True)
...
class EstruturasTalhaos(models.Model):
    ...
    estrutura_sera_afectada = models.CharField(max_length=255, null=True, blank=True)
    ...
    nivel_afectacao_estrutura = models.CharField(max_length=255, null=True, blank=True)
    ...
    material_cobertura_estruturas = models.CharField(max_length=255, null=True, blank=True)
    outro_material_tecto = models.CharField(max_length=255, null=True, blank=True)
    material_das_paredes = models.CharField(max_length=255, null=True, blank=True)
    material_de_soalho_das_estruturas = models.CharField(max_length=255, null=True, blank=True)
    outro_material_soalho = models.CharField(max_length=255, null=True, blank=True)
...
class ReligiaoELocaisSagrados(models.Model):
    ...
    onde_enterra_entequeridos = models.CharField(max_length=255, null=True, blank=True)
    familia_tem_campas = models.CharField(max_length=255, null=True, blank=True)
    frequencia_com_que_vai_cemiterio = models.CharField(max_length=255, null=True, blank=True)

class Pecuaria(models.Model):
    inquerito = models.OneToOneField(Inquerito, on_delete=models.CASCADE)
    familia_cria_animais = models.CharField(max_length=255, null=True, blank=True)
    familia_possui_arvores = models.CharField(max_length=255, null=True, blank=True)
...
class EducacaoSaude(models.Model):
    inquerito = models.OneToOneField(Inquerito, on_delete=models.CASCADE)
    existe_escola_no_bairro = models.CharField(max_length=255, null=True, blank=True)
    tem_membro_estudante = models.CharField(max_length=255, null=True, blank=True)
    ...
    existe_centro_saude = models.CharField(max_length=255, null=True, blank=True)
    nome_centro_saude = models.CharField(max_length=255, null=True, blank=True)
    onde_procura_tratamento = models.CharField(max_length=255, null=True, blank=True)
